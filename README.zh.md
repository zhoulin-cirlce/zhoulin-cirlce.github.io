...
* 如果你喜欢我的这个博客模板，请在`zhoulin-cirlce.github.io`这个repository点个赞——右上角**star**一下。
...
```
# Site settings
title: Zhoulin-cirlce Blog             # 你的博客网站标题
SEOTitle: zhoulin-cirlce Blog			# 在后面会详细谈到
description: "Cool Blog"    # 随便说点，描述一下

# SNS settings      
github_username: zhoulin-cirlce     # 你的github账号
weibo_username: 心贝贝__      # 你的微博账号，底部链接会自动更新的。
...
sidebar-avatar: /img/avatar-circle.jpg     #你的大头贴，请使用绝对地址.
```
...
我的博客标题是 **“Zhoulin-cirlce Blog”** 但是我想要在搜索的时候显示 **“cirlce的博客 | Zhoulin-cirlce Blog”** ，这个就需要SEO Title来定义了。
